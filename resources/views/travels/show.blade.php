...
<nav class="navbar navbar-expand-lg nav-color justify-content-around text-dark">
    <div class="container">
        ...
        <div class="container">
            <div class="row  my-5">
                ...
                <div class="col-12 col-md-6">
                    <img src="{{ Storage::url($travels->img) }}" class="img-fluid w-70" alt="">
                </div>
                
                <div class="col-12 col-md-6">
                    <p class="lead">Place name: {!! $travels->name !!}</p>
                    <p class="lead">State: {!! $travels->state !!}</p>
                    <p class="lead">Description: {!! $travels->description !!}</p>
                </div>
            </div>
        </div>
